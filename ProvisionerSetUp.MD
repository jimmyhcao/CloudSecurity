...
<li> However, if we connect to our VM with SSH, we will be able to accept the key </li>
Run
```
...
```
<br><p align="center"><img src="https://i.imgur.com/kkz3qEW.png" height="70%" width="70%">
